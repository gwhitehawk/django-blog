...
from blog.fields import MathField
from blog.util import encode, decode
...
class MathCaptchaModelForm(forms.ModelForm):
    ...
    def clean(self):
        cleaned_data = super(MathCaptchaModelForm, self).clean()
        math_clean(self)
        return cleaned_data
...
class MathCaptchaForm(forms.Form):
    ...
    def clean(self):
        cleaned_data = super(MathCaptchaForm, self).clean()
        math_clean(self)
        return cleaned_data
